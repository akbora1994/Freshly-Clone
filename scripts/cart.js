var data = [
    {
        ...
        description: "with Sauteed Carrots & French Green Beans",
    ...
    },
    {
        ...
        description: "with Masterful Mac & Cheese",
    ...
    },
    {
        ...
        description: "with Nonna's Soffritto & Italian Cheeses",
    ...
    },
    {
        ...
        description: "with Sauteed Zucchini & Spinach",
    ...
    },
    {
        ...
        description: "with Sauteed Zucchini & Spinach",
        meal: "370 Cal | Gluten Free | Single-Serve",
        category: "Proteins",
        price: "11.79"
    },
    {
        ...
        description: "with Basmati Rice & Veggies",
    ...
    },
    {
        ...
        description: "with Mozzarella & Garlicky Broccoli",
        meal: "490 Cal | Gluten Free | Single-Serve",
        category: "Proteins",
        price: "11.79"
    },
    {
        ...
        description: "with Roasted Sweet Corn",
    ...
    },
    {
        ...
        description: "with Hearty White Beans & Kale",
        meal: "370 Cal | Gluten Free | Single-Serve",
        category: "Purely Plant",
        price: "11.79"
    },
    ...
    },
    {
        ...
        description: "with Basmati Rice & Veggies",
        meal: "190 Cal | Gluten Free | Multi-Serve",
        category: "Freshly Fit",
        price: "11.79"
    },
    {
    ...
    },
    {
        ...
        name: "Grilled Chicken Breasts(9.75 oz)",
        description: "with Sauteed Zucchini & Spinach",
        meal: "490 Cal | Gluten Free | Single-Serve",
        category: "Purely Plant",
        price: "11.79"
    },
    {
        ...
        name: "Baked Turkey Meatballs(9.98 oz)",
        description: "with Basmati Rice & Veggies",
        meal: "370 Cal | Gluten Free | Single-Serve",
        category: "Freshly Fit",
        price: "11.79"
    ...
    },
    {
        ...
        description: "with Nonna's Soffritto & Italian Cheeses",
        meal: "360 Cal | Gluten Free | Multi-Serve",
    ...
    },
    {
        ...
        description: "with Mozzarella & Garlicky Broccoli",
        meal: "460 Cal | Gluten Free | Multi-Serve",
        category: "Freshly Fit",
        price: "11.79"
    },
    {
...
var addedItems = JSON.parse(localStorage.getItem("itemsInCart")) || [];
...
function createCards(data) {
    ...
    data.map(item => {
        ...
        midDiv.append(heading, desc);
        bottomDiv.append(btn);
        box.append(imageDiv, midDiv, bottomDiv);
        document.querySelector(".cardsContainer").append(box);
    });
}
...
document.querySelector("#filterSelect").addEventListener("change", () => {
    var selectFilter = document.querySelector("#filterSelect").value;
    var filteredArr = data.filter(item => {
...
function addToCart(addedItems) {
    document.querySelector("#addedCardsContainer").innerHTML = "";
    addedItems.map((item, index) => {
        var cardBox = document.createElement("div");
        cardBox.setAttribute("id", "addedCards");

        var imageDiv = document.createElement("div");
        imageDiv.setAttribute("id", "lastImageDiv");

        var image = document.createElement("img");
       
        image.setAttribute("id", "lastImage");
        image.setAttribute("src",  item.image);

        var middleDiv = document.createElement("div");
        middleDiv.setAttribute("id", "middleDiv");
        middleDiv.textContent = item.name;

        var lastDiv = document.createElement("div");
        lastDiv.setAttribute("id", "lastDiv");

        var lastDiv1 = document.createElement("div");
        lastDiv1.setAttribute("id", "lastDiv1");
        lastDiv1.textContent = "+";

        lastDiv1.addEventListener("click", () => {
            addedItems.push(item);
            localStorage.setItem("itemsInCart", JSON.stringify(addedItems));
            addToCart(addedItems);
            total(addedItems);
        ...
        lastDiv2.textContent = "-";

        lastDiv2.addEventListener("click", () => {
            addedItems.splice(index, 1);
            localStorage.setItem("itemsInCart", JSON.stringify(addedItems));
            addToCart(addedItems);
            if (addedItems.length == 0) {
                document.querySelector("#addedCardsTotal").innerHTML = "Get started by adding at least 4 meals";
                document.querySelector("#mealNum2").textContent = addedItems.length;
                document.querySelector("#totalSum3").textContent = 0;
            }
            else {
                location.reload();
                total(addedItems);
        ...
        imageDiv.append(image);
        lastDiv.append(lastDiv1, lastDiv2);
        cardBox.append(imageDiv, middleDiv, lastDiv);
        document.querySelector("#addedCardsContainer").append(cardBox);
    });
}
...
function total(addedItems) {
    var totalSum = addedItems.reduce((ac, item) => {
        return Number((ac + Number(item.price)).toFixed(2));
    }, 0);
    var length = addedItems.length;

    document.querySelector("#totalSum1").textContent = `$ ${totalSum}`;
    document.querySelector("#totalSum2").textContent = `$ ${totalSum}`;
    document.querySelector("#totalSum3").textContent = `$ ${totalSum}`;
    document.querySelector("#mealNum").textContent = addedItems.length;
    document.querySelector("#mealNum2").textContent = addedItems.length;

    localStorage.setItem("total", JSON.stringify(totalSum));
    localStorage.setItem("length", JSON.stringify(length));

    if (addedItems.length >= 4) {
        document.querySelector("#mealNum2").style.color = "green";
    }

    if (addedItems.length < 4) {
        document.querySelector("#mealLeft").textContent = 4 - addedItems.length;
    }
    else {
        document.querySelector("#lastBtn").style.backgroundColor = "rgb(42, 109, 255)";
        document.querySelector("#btnnn").style.backgroundColor = "rgb(42, 109, 255)";
        document.querySelector("#btnnn").style.border = "rgb(42, 109, 255)";
        document.querySelector("#btnnn").style.color = "white";
        document.querySelector("#btnnn").style.color = "white";
        document.querySelector("#btnnn").textContent = "Next";
    }
}
...
document.querySelector("#dateJs1").textContent = date;
